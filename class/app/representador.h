...
class Representador
{
	...
	void 			dibujar_poligono(DLibV::Pantalla&, const DLibH::Poligono_2d<double>&, tcolor, const Struct_camara&);
	void 			dibujar_poligono_lineas(DLibV::Pantalla&, const DLibH::Poligono_2d<double>&, tcolor, const Struct_camara&);
	void 			dibujar_segmento(DLibV::Pantalla&, const DLibH::Segmento_2d<double>&, tcolor, const Struct_camara&);
